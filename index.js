...
console.log('task 1a:', createMenuItem('Tacos','25','Beef'));
...
console.log('task 1b', createMenuItem('chicken', 8, 'dinner'));
console.log('task 1b', createMenuItem('candy', 20, 'snack'));
...
reviews[7].feedback = 'I would love to tell more people about this!';

console.log('task 4:', reviews);

// reviews.push({name: 'Ana', rating: 5, feedback: 'Love this place!'});
...
console.log(reviews, 'tom', 5, 'Best place!');
...
function getLastReview(array) {
  return `${array[array.length -1].name} gave the restaurant a ${array[array.length -1].rating} star rating, and their feedbck was: ${array[array.length-1].feedback}`;
} 
